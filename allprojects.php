  ...
  <div class="main-wrapper">
   ...
   <div class="page-content">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
      <div>
        <h4 class="mb-3 mb-md-0">Welcome to All Project Dashboard</h4>
      </div>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  foreach( $result as $row ) {
                    ...
                    echo '<td><a href="viewproject.php?id='.$projid.'"><button type="button" class="btn btn-warning btn-sm mr-1 mb-1 mb-md-0">View</button></a><a href="markproject.php?id='.$projid.'&status=3"><button type="button" class="btn btn-info btn-sm mr-1 mb-1 mb-md-0">Pending</button></a><a href="markproject.php?id='.$projid.'&status=1"><button type="button" class="btn btn-primary btn-sm mr-1 mb-1 mb-md-0">In Progress</button></a><a href="markproject.php?id='.$projid.'&status=2"><button type="button" class="btn btn-success btn-sm mr-1 mb-1 mb-md-0">Completed</button></a><a href="markproject.php?id='.$projid.'&status=4"><button type="button" class="btn btn-danger btn-sm mr-1 mb-1 mb-md-0">X</button></a></td>';
                    echo '</tr>';    
