  ...
  <div class="main-wrapper">
   ...
   <div class="page-content">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
      <div>
        <h4 class="mb-3 mb-md-0">Welcome to Staff Manager</h4>
      </div>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  foreach( $result as $row ) {
                    ...
                    if($projstaff == 0){
                      echo '<td><span class="badge badge-pill badge-info">Customer</span></td>';

                    } else {

                      echo '<td><span class="badge badge-pill badge-danger">Staff</span></td>';
                    }
                    echo '<td>' . '<a href="setstaff.php?id='.$projid.'&status=2"><button type="button" class="btn btn-info btn-sm mr-1 mb-1 mb-md-0">Set Customer</button></a> <a href="setstaff.php?id='.$projid.'&status=1"><button type="button" class="btn btn-danger btn-sm mr-1 mb-1 mb-md-0">Set Staff</button></a>';
                    echo '</tr>';    
