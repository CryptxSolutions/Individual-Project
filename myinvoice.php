              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-6 col-md-12 col-xl-5"><br>
                    ...
                    $query = $db->prepare("SELECT COUNT(1) FROM `projects` WHERE `status` = 0 AND `email` = '$useremail'");
                    $query->execute();
                    $result = $query -> fetchAll();
                    foreach( $result as $row ) {
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-6 col-md-12 col-xl-5"><br>
                    ...
                    $query = $db->prepare("SELECT COUNT(1) FROM `projects` WHERE `status` = 3 AND `email` = '$useremail'");
                    $query->execute();
                    $result = $query -> fetchAll();
                    foreach( $result as $row ) {
